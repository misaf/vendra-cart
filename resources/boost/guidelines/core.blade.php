...
- Keep the package independent of product models, catalog implementations, and concrete tenant providers. Register `CartResource` as a standalone resource; sellables from any module resolve through the polymorphic relationship.
...
- Keep Filament resources thin, with forms in `Schemas`, tables in `Tables`, and items managed through the cart relation manager. The administration UI may inspect and delete carts/items but must not edit external sellables.
